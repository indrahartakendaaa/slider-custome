    ...
    <div class="accomodation">
        ...
        <div class="cover cover-full" style="background: url(<?php echo $prefix;?>assets/img/common/bg_snowtrees.jpg) no-repeat center; background-size: cover;">
          <div class="container justify-content-center">
            <div class="cover-content text-center">
              <h1 class="cover-title">The Attic Loft</h1>
            </div>
          </div>
        </div>
        <!-- END: Cover -->
      ...
      <section class="">
        <div class="container py-main border-bottom">
          <div class="row">
            <div class="col-md-6">
              <h3 class="font-weight-light">The perfect couples’ getaway.</h3>
        ...
        <div class="container py-main border-bottom">
          ...
          <div class="row">
            <div class="col-6 col-md-6">
              <div class="img-wrapper mb-20px" style="background: linear-gradient(rgba(0,0,0,.3),rgba(0,0,0,.3)), url(<?php echo $prefix;?>assets/img/common/bg_rectangle-light-3.jpeg) no-repeat center; background-size: cover;">
              </div>
            </div>
            <div class="col-6 col-md-6">
              <div class="img-wrapper mb-20px" style="background: linear-gradient(rgba(0,0,0,.3),rgba(0,0,0,.3)), url(<?php echo $prefix;?>assets/img/common/bg_rectangle-light-3.jpeg) no-repeat center; background-size: cover;">
            ...
            <div class="col-6 col-md-6">
              <div class="img-wrapper mb-20px" style="background: linear-gradient(rgba(0,0,0,.3),rgba(0,0,0,.3)), url(<?php echo $prefix;?>assets/img/common/bg_rectangle-light-2.jpg) no-repeat center; background-size: cover;">
              </div>
            </div>
            <div class="col-6 col-md-6">
              <div class="img-wrapper mb-20px" style="background: linear-gradient(rgba(0,0,0,.3),rgba(0,0,0,.3)), url(<?php echo $prefix;?>assets/img/common/bg_rectangle-light-1.jpg) no-repeat center; background-size: cover;">
              </div>
            </div>
          </div>
        </div>
